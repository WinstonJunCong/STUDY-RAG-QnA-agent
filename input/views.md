---
title: Views
url: https://en.esotericsoftware.com/spine-views
...
Currently views cannot be moved outside the [Spine window](https://en.esotericsoftware.com#Multiple-monitors).
...
![Screenshot: Open](https://en.esotericsoftware.com/img/spine-user-guide/views/open.png)
...
![Screenshot: Tab](https://en.esotericsoftware.com/img/spine-user-guide/views/tab.png)

The tab can be dragged to move it to a new position. An orange rectangle will appear where the tab can be dropped.

![Screenshot: Move](https://en.esotericsoftware.com/img/spine-user-guide/views/move.png)

A tab can also be dropped next to other tabs.

![Screenshot: Tabs](https://en.esotericsoftware.com/img/spine-user-guide/views/tabs.png)
...
![Screenshot: Resize](https://en.esotericsoftware.com/img/spine-user-guide/views/resize.png)
...
![Screenshot: Minimize](https://en.esotericsoftware.com/img/spine-user-guide/views/minimize.png)
...
![Screenshot: Minimized Icons](https://en.esotericsoftware.com/img/spine-user-guide/views/minimized-icons.png)
...
![Screenshot: Close](https://en.esotericsoftware.com/img/spine-user-guide/views/close.png)
...
![Screenshot: Toolbar](https://en.esotericsoftware.com/img/spine-user-guide/views/toolbar.png)
